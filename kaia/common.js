...
const chainId = 8217;
const common = Common.custom({ chainId: chainId, hardfork: Hardfork.London, eips: [1559] });
...
async function updateGas () {
    ...
    if (ethGasStationData.id == 1) {
      let gasPrice = parseInt(ethGasStationData.result)
      let maxFeePerGas = parseInt(gasPrice)
